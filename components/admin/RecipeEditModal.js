        ...
        <DialogHeader className="p-6 bg-gradient-to-r from-orange-50 via-amber-100/50 to-orange-50 border-b border-orange-100">
          <DialogTitle className="text-2xl font-semibold text-orange-900 flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center">
              <svg className="h-5 w-5 text-orange-600" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          ...
          <p className="text-orange-600/80 mt-1">
            {recipe?._id ? 'Update your recipe details' : 'Create a delicious new recipe'}
          </p>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 p-6">
          <Tabs defaultValue="basic" className="w-full">
            <TabsList className="grid w-full grid-cols-4 bg-orange-50/50 p-1 rounded-lg">
              {['basic', 'ingredients', 'instructions', 'settings'].map((tab) => (
                <TabsTrigger
                  key={tab}
                  value={tab}
            ...
            <div className="mt-6 bg-orange-50/30 rounded-lg p-6">
              <TabsContent value="basic" className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="title" className="text-orange-900 font-medium">Title</Label>
                    <Input
                      id="title"
                      name="title"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="image" className="text-orange-900 font-medium">Recipe Image</Label>
                    <div className="space-y-3">
                      ...
                      {!formData.image && !imageFile && (
                        <p className="text-sm text-orange-600">Please upload a recipe image (JPEG, PNG, or WebP, max 5MB)</p>
                      )}
                    </div>
                  </div>
              ...
              <TabsContent value="ingredients" className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-orange-100">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-semibold text-orange-900">Ingredients</h3>
                    <Button
                      type="button"
              ...
              <TabsContent value="instructions" className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-orange-100">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-semibold text-orange-900">Instructions</h3>
                    <Button
                      type="button"
              ...
              <TabsContent value="settings" className="space-y-4">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-orange-100">
                  <div className="space-y-4">
                    <Label className="text-orange-900 font-medium">Status</Label>
                    <Select
