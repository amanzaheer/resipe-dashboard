...
export const favoritesAPI = {
  ...
  add: (recipeId) => {
    ...
    return api.post('/api/favorites', { recipe: recipeId })  // Changed to match backend expectation
      .then(response => {
  ...
  remove: (recipeId) => {
    ...
    return api.post('/api/favorites/delete', { recipe: recipeId })  // Changed to POST with recipe field
      .then(response => {
